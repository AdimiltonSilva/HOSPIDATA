...
('COMPRAS', 'EDIFÍCIO E, 5º ANDAR'),
('JURÍDICO', 'EDIFÍCIO A, 1º ANDAR'),
('ALMOXARIFADO', 'EDIFÍCIO C, TÉRREO');
...
(5, 2, 'ADIMILTON ANTONIO', 'DESENVOLVEDOR FULL STACK', '2020-01-15', 8250.00, 1265.00),
(6, 13, 'ALOISIO BRAGA', 'CIENTISTA DE DADOS', '2020-01-15', 8250.00, 1250.00),
(7, 1, 'JENSEN FONG', 'GERENTE DE TI', '2020-01-15', 12000.00, 1250.00);
